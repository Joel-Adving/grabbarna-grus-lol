            ...
            <div className="container flex flex-row">
                <div className="flex flex-col flex-grow">
                    {matchHistory && summoner && filter === 'MATCH_HISTORY' && (
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="flex flex-col justify-center h-full">
                                <div className="flex items-center justify-center flex-grow py-3 border-b-2 border-border bg-slate-4000 sm:justify-start">
                    ...
                    <div className="flex w-full">
                        {summoner && matchHistory && !loading && filter === 'MATCH_HISTORY' && (
